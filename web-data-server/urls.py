...
from views import current_datetime, station_data_available, list_stations, publish_data, rsm_data, infowindow
...
urlpatterns = patterns('',
  ...
  (r'^([a-z])/([A-Z]{4})(\d{0,3})/$', station_data_available),	# Lists Stations directories
	...
	(r'^([a-z])/([A-Z]{4}(\d{0,3}))/rsm/', infowindow),						# Prints info wiindow for ui-server
